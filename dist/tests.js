...
var numbers = new index_1.NumberArray([0]);
if (numbers.className && numbers.className === 'NumberArray')
...
if (numbers.areOrdered)
    console.log('test 10 passed');
else
    console.log('test 10 FAILED');
if (numbers.allInRange([0, 0]))
...
if (errorTriggered)
    console.log('test 16A passed');
else
    console.log('test 16A FAILED');
numbers.set([20, -3.005, 4, 7, 31, 59]);
if (numbers.length === 6)
    console.log('test 16B passed');
else
    console.log('test 16B FAILED');
if (numbers.min === -3.005 && numbers.max === 59)
    console.log('test 17 passed');
else
    console.log('test 17 FAILED');
if (numbers.difference === 62.005)
    console.log('test 18 passed');
else
    console.log('test 18 FAILED');
if (numbers.sum === 117.995)
    console.log('test 19 passed');
else
    console.log('test 19 FAILED');
if (in_range_1.inRange([19.665833333333, 19.665833333334], numbers.average))
    console.log('test 20 passed');
else
    console.log('test 20 FAILED');
if (numbers.product === -3077841.1999999993)
    console.log('test 21 passed');
else
    console.log('test 21 FAILED');
if (numbers.median === 13.5)
...
if (numbers.data[0] === 20000)
    console.log('test 27 passed');
else
    console.log('test 27 FAILED');
if (numbers.asString() === '20000, 7, 59, -3.005, 20, 31, 4')
